...
/**
 * Inverte a ordem da data de expiração de MM/YYYY para YYYY/MM.
 *
 * @param {String} expiration
 *
 * @return {String}
 */
exports.expirationReverse = function(expiration)
{
    expiration = String(expiration).split('/');

    return expiration[1] + '/' + expiration[0];
};
